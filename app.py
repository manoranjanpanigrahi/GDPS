...
def parkinsonpredict():
    ...
    if predict == 1:
        return render_template("parkinsonpredict.html", prediction="There is a high chance that you have Parkinson Disease. Consult your Doctor.")
    else:
        return render_template("parkinsonpredict.html", prediction="You don't seem to have Parkinson Disease, but still take care of your health and do regular check-ups.")
